...
public class Camera {
    ...
    public Camera() {
        _P0 = new Point3D();
        _vTo = new Vector(new Point3D(new Coordinate(0), new Coordinate(0), new Coordinate(-1)));
        _vUp = new Vector(new Point3D(new Coordinate(0), new Coordinate(1), new Coordinate(0)));
...
//copy vTo, vRight and vUp so they don't change when scaled
        ...
        Point3D  cpyP0=new Point3D(getP0());
        //obtain image center Pc
        Point3D Pc = new Point3D(cpyP0.add(cpyVto.scalingV(screenDistance)));
